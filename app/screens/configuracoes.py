...
def page():
    ...
    sync_key=os.getenv('SYNC_API_KEY','').strip();local_picker_token=hashlib.sha256((sync_key+'|operacional-local-picker').encode()).hexdigest() if len(sync_key)>=24 else ''
